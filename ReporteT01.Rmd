...
PL _platform_, plataforma usada para generar las lecturas: Illumina. Para conocer la plataforma utilizada, existe la etiqueta PL, que se puede encontrar en el encabezado del archivo BAM.
...
AS _genome assembly identifier_, versión del ensamblaje humano: NCBI37 (**GRCh37** Genome Reference Consortium Human Build 37). 

Las entradas @SQ del encabezado contienen información acerca de las secuencias de referencia. El AS nos habla acerca del genoma de referencia utilizado para realizar el alineamiento.
