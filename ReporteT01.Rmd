...
Hay 44 posiciones en las que no hay un genotipo de referencia y tienen cobretura mayor a 10.
...
# Ambos filtros
bcftools view -s HG00107 -i ' REF="." && DP>10' 1kg.vcf 

#Contar las posiciones
bcftools view -s HG00107 -i ' REF="." && DP>10' 1kg.vcf | wc -l 
```
