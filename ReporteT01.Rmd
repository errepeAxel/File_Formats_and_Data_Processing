...
Lecturas de grupo (read group). Pueden contener la información acerca de las lecturas de grupo.
...
PL: plataforma usada para generar las lecturas: Illumina
...
GATK (Genome Analysis Toolkit) IndelRealigner VN: 1.0.4487, GATK TableRecalibration VN: 1.0.4487 y bwa (Burrows-Wheeler Aligner) VN: 0.5.5
