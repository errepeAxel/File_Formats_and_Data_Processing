...
RG: _read group_, lecturas de grupo. Pueden contener la información acerca de las lecturas de grupo.

## ¿Qué es "lane ID"?

Número de identificación para cada lectura de grupo, este número es único.

## ¿Cuál es la plataforma de secuenciación?

PL _platform_, plataforma usada para generar las lecturas: Illumina

## ¿Qué versión de ensamblaje humano se usó para realizar las alineaciones?

AS _genome assembly identifier_, versión del ensamblaje humano: NCBI37

## ¿Qué programadas fueron utlizados para crear este archivo BAM?

GATK _(Genome Analysis Toolkit)_ IndelRealigner VN: 1.0.4487, GATK TableRecalibration VN: 1.0.4487 y bwa _(Burrows-Wheeler Aligner)_ VN: 0.5.5
